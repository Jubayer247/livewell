...
import com.deshsomachar.livewell.helper.DatabaseHandler;
import com.deshsomachar.livewell.helper.Functions;
import com.deshsomachar.livewell.helper.SessionManager;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        walkbtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent walk=new Intent(HomeActivity.this,MainActivity.class);
                startActivity(walk);
            }
        });
